    ...
    <>
      ...
      <section className="flex flex-col items-center justify-center text-center py-28 gap-6">
        ...
        <p className="text-lg text-zinc-400 max-w-md">
          Crea torneos privados, predice los podios de cada Gran Premio y
          compite por la gloria en la temporada 2025.
        </p>
        <div className="flex flex-wrap gap-3 justify-center mt-2">
          <Link
            ...
            className={cn(
              ...
              "bg-red-600 hover:bg-red-700 text-white font-semibold px-8"
            )}
          >
            Empezar a jugar
          </Link>
      ...
      {/* How it works */}
      <section className="pb-24 max-w-5xl mx-auto w-full">
